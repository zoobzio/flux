...
Flux emits [capitan](https://github.com/zoobz-io/capitan) signals at key points in the configuration lifecycle. This reference covers all signals and field keys.
